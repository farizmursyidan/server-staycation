...
module.exports = {
  ...
  addCategory: async (req, res) => {
    try {
      ...
      req.flash('alertMessage', 'New category has been added!');
  ...
  addBank: async (req, res) => {
    try {
      ...
      await Bank.create({ name, bankName, accountNumber, imageUrl: `images/${req.file.filename}` });
      req.flash('alertMessage', 'New bank has been added!');
      req.flash('alertStatus', 'success');
      res.redirect('/admin/bank');
    } catch (error) {
      req.flash('alertMessage', `${error.message}`);
  ...
  addItem: async (req, res) => {
    try {
      ...
      if (req.files.length > 0) {
        ...
        req.flash('alertMessage', 'New item has been added!');
        req.flash('alertStatus', 'success');
        res.redirect('/admin/item');
      }
    } catch (error) {
  ...
  addFeature: async (req, res) => {
    try {
      ...
      await item.save();
      req.flash('alertMessage', 'New feature has been added!');
      req.flash('alertStatus', 'success');
      res.redirect(`/admin/item/show-detail-item/${itemId}`);
    } catch (error) {
      req.flash('alertMessage', `${error.message}`);
  ...
  addActivity: async (req, res) => {
    try {
      ...
      await item.save();
      req.flash('alertMessage', 'New activity has been added!');
      req.flash('alertStatus', 'success');
      res.redirect(`/admin/item/show-detail-item/${itemId}`);
    } catch (error) {
      req.flash('alertMessage', `${error.message}`);
